...
public class SnmpTrapGeneratorClient {
	...
	private static final String USER = "ISGKP";
...
//		sendSnmpV2Trap();
	 ...
	 */
	public static void sendSnmpV1Trap() {
		try {
	...
	public static void sendSnmpV3Trap() {
		try {
			...
			snmp.getUSM().addUser(
					...
					new UsmUser(new OctetString(USER), null, null, null,
							null));
...
//			pdu.add(new VariableBinding(SnmpConstants.snmpTrapOID, new OID("1.3.6.1.4.1.89.0.151")));
//			pdu.add(new VariableBinding(new OID("1.3.6.1.4.1.89.2.3.1.0"), new OctetString("%STP-W-PORTSTATUS: gi0/22: STP status Forwarding")));
//			pdu.add(new VariableBinding(new OID("1.3.6.1.4.1.89.2.3.2.0"), new Integer32(1)));
//			pdu.add(new VariableBinding(new OID("1.3.6.1.4.1.89.57.2.8.1.0"), new Integer32(70)));
//			pdu.add(new VariableBinding(new OID("1.3.6.1.4.1.89.57.2.8.2.0"), new Integer32(0)));
			
			pdu.add(new VariableBinding(SnmpConstants.snmpTrapOID, new OID("1.3.6.1.6.3.1.1.5.3")));
			pdu.add(new VariableBinding(new OID("1.3.6.1.2.1.2.2.1.1.70"), new Integer32(70)));
			pdu.add(new VariableBinding(new OID("1.3.6.1.2.1.2.2.1.7.70"), new Integer32(1)));
			pdu.add(new VariableBinding(new OID("1.3.6.1.2.1.2.2.1.8.70"), new Integer32(1)));
