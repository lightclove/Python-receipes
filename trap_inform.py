...
SNMP TRAP and Inform Receiver for SNMP V1,V2c,V3
...
try:
    ...
    print
    "IMPORT ERROR Please install PYSNMP 4.3.8 usning"
...
def user_input(snmpEngine):
    ...
    if vserion in ['1', '2']:
        ...
        while 1:
            ...
            asn = raw_input("Want to add a another community ("
...
def add_transport(snmpEngine, PORT, ip_type):
    ...
    try:
        ...
        print
        "Port Binding Failed the Provided Port {} is in Use".format(PORT)
...
def cbFun(snmpEngine, stateReference, contextEngineId, contextName,
    ...
    print
    "####################### NEW Notification(PDU_COUNT: {}) #######################".format(pdu_count)
